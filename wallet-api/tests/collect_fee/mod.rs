...
use wallet_api::{
    ...
    test_support::{
        ...
        collect_fee::{bump_sol_native_transfer_value_for_rent, is_solana_recipient_rent_error},
    },
};
...
impl Tx for RentAwareAdapter {
    ...
    async fn balance_token_key(&self, _addr: &str, _token: AssetTokenKey) -> Result<U256, Error> {
        Ok(U256::ZERO)
    }
