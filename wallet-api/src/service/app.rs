    ...
    AppService<T>
{
    ...
    pub async fn get_official_website(self) -> Result<GetOfficialWebsiteRes, crate::error::ServiceError> {
    ...
    pub async fn get_config(self) -> Result<GetConfigRes, crate::error::ServiceError> {
        let config = crate::app_state::APP_STATE.read().await;
    ...
    pub async fn get_unread_status(
        self,
    ) -> Result<crate::response_vo::app::UnreadCount, crate::error::ServiceError> {
        let mut tx = self.repo;
        let unread_announcement_count = AnnouncementRepoTrait::count_unread_status(&mut tx).await?;
        let unread_system_notification_count =
            SystemNotificationRepoTrait::count_unread_status(&mut tx).await?;
    ...
    pub async fn language_init(self, language: &str) -> Result<(), crate::error::ServiceError> {
    ...
    pub async fn check_version(self, r#type: &str) -> Result<AppVersionRes, crate::error::ServiceError> {
    ...
    // fiat  = CNY
    pub async fn set_fiat(&mut self, fiat: &str) -> Result<(), crate::error::ServiceError> {
    ...
    pub async fn set_app_id(mut self, app_id: &str) -> Result<(), crate::error::ServiceError> {
    ...
    pub async fn get_fiat(self) -> Result<GetFiatRes, crate::error::ServiceError> {
        let config = crate::app_state::APP_STATE.read().await;

        Ok(GetFiatRes { fiat: config.currency().to_string() })
    }

    pub async fn set_block_browser_url(&mut self) -> Result<(), crate::error::ServiceError> {
        // let tx = &mut self.repo;
    ...
    pub async fn mqtt_resubscribe(self) -> Result<(), crate::error::ServiceError> {
        // 获取全局已订阅的主题
        let global_topics = crate::context::CONTEXT.get().unwrap().get_global_mqtt_topics();
    ...
    pub async fn get_configs(self) -> Result<Vec<ConfigEntity>, crate::error::ServiceError> {
        let pool = crate::context::CONTEXT.get().unwrap().get_global_sqlite_pool()?;
    ...
    pub async fn set_config(
        ...
        key: String,
        value: String,
    ) -> Result<ConfigEntity, crate::error::ServiceError> {
        let pool = crate::context::CONTEXT.get().unwrap().get_global_sqlite_pool()?;
    ...
    pub async fn set_min_value_config(
        ...
        amount: f64,
        switch: bool,
    ) -> Result<MinValueSwitchConfig, crate::error::ServiceError> {
        let pool = crate::context::CONTEXT.get().unwrap().get_global_sqlite_pool()?;
    ...
    pub async fn get_min_value_config(
        self,
        symbol: String,
    ) -> Result<Option<MinValueSwitchConfig>, crate::error::ServiceError> {
        let pool = crate::context::CONTEXT.get().unwrap().get_global_sqlite_pool()?;
    ...
    pub async fn request_backend(
        ...
        endpoint: &str,
        body: String,
    ) -> Result<serde_json::Value, crate::error::ServiceError> {
        let backend = crate::context::CONTEXT.get().unwrap().get_global_backend_api();
    ...
    pub async fn global_msg(self) -> Result<GlobalMsg, crate::error::ServiceError> {
