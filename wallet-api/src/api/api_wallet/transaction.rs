use crate::{
    ...
    service::{
        api_wallet::transaction::ApiTransService, bill::BillService,
...
impl WalletManager {
    ...
    //     ApiTransService::list_by_hashs(owner, hashs).await
    // }
    ...
    //     ApiTransService::recent_bill(&token, &addr, &chain_code, page, page_size).await
    // }
    ...
    // pub async fn api_sync_bill(&self, chain_code: String, address: String) -> ReturnType<()> {
    //     BillService::sync_bill_by_address(&chain_code, &address).await
    // }

    // pub async fn api_sync_bill_by_wallet_and_account(
    //     &self,
    ...
    // // 币汇率
    // pub async fn api_coin_currency_price(
    //     &self,
    //     chain_code: String,
    //     symbol: String,
