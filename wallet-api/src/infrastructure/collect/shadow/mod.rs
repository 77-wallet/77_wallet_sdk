...
// 重新导出内部模块的类型，方便外部使用
pub use actor::{CollectorShadowActorSystem, ScannerActorMessage, DispatcherActorMessage};
...
pub async fn init(
    ...
    confirm_report_tx: mpsc::Sender<crate::infrastructure::collect::command::ProcessCollectTxConfirmReportCommand>,
    ...
    // 初始化Shadow Actor系统
    let actor_system = actor::CollectorShadowActorSystem::new(
        pool,
        tx_tx,
        report_tx,
        confirm_report_tx,
