...
pub fn collect_stage_to_diagnose_stage(
    stage: crate::infrastructure::collect::shadow::stage::CollectStage,
) -> DiagnoseStage {
    match stage {
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedOrderAck => {
            DiagnoseStage::OrderAck
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::CanBuild => {
            DiagnoseStage::Build
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedTxFeeResAck => {
            DiagnoseStage::TxFeeResAck
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::CanBroadcast => {
            DiagnoseStage::Broadcast
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedRecover => {
            DiagnoseStage::Recover
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedTxExecReceiptUpload => {
            DiagnoseStage::TxExecReceipt
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedResultAck => {
            DiagnoseStage::ResultAck
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::NeedServiceFeeUpload => {
            DiagnoseStage::ServiceFeeUpload
        }
        crate::infrastructure::collect::shadow::stage::CollectStage::FullyBlocked => {
