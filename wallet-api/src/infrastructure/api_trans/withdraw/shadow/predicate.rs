...
mod tests {
    ...
    #[test]
    fn withdraw_resource_gate_waits_when_resource_dependency_is_in_progress() {
        let mut waiting_platform = base_withdraw();
        ...
        let retry_eval = evaluate_point(AdvancementPoint::NeedResourceGate, &needs_local_task);
