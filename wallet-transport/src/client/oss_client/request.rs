...
impl RequestBuilder {
    ...
    pub fn response_content_disposition<S: AsRef<str>>(mut self, file_name: S) -> Self {
        self.parameters.insert(
            ...
            format!("attachment;filename={}", file_name.as_ref()),
        );
        self
    }
    #[allow(dead_code)]
    pub fn oss_signature_version2(mut self) -> Self {
        self.parameters
            .insert("x-oss-signature-version".to_string(), "OSS2".to_string());
        self
    }
    #[allow(dead_code)]
    ...
    pub fn oss_download_speed_limit<S: Into<i32>>(mut self, speed: S) -> Self {
        ...
        self.parameters.insert(
            "x-oss-traffic-limit".to_string(),
            (speed * 1024 * 8).to_string(),
        );
        self
    }
    #[allow(dead_code)]
    ...
    {
        self.parameters
            .insert("x-oss-ac-source-ip".to_string(), ip.as_ref().to_string());
        self.parameters
            .insert("x-oss-ac-subnet-mask".to_string(), mask.into().to_string());
        self
    }
    #[allow(dead_code)]
    pub fn oss_ac_forward_allow(mut self) -> Self {
        self.parameters
            .insert("x-oss-ac-forwarded-for".to_string(), "true".to_string());
        self
    }
    #[allow(dead_code)]
