...
async fn test_custom_token_init() -> Result<(), Error> {
    ...
    let res = backend_api
        .custom_token_init(&aes_cbc_cryptor, req)
        .await
        .unwrap();
...
async fn test_token_subscribe() -> Result<(), Error> {
    ...
    let res = backend_api
        .token_subscribe(&aes_cbc_cryptor, req)
        .await
        .unwrap();
...
async fn test_token_query_currency() -> Result<(), Error> {
    ...
    let res = backend_api
        .token_query_by_currency(&aes_cbc_cryptor, "tron", "USDT", "trx")
        .await
        .unwrap();
...
async fn test_token_cancel_subscribe() -> Result<(), Error> {
    ...
    let res = backend_api
        .token_cancel_subscribe(&aes_cbc_cryptor, req)
        .await
        .unwrap();
...
async fn test_token_query_price() -> Result<(), Error> {
    ...
    let res = backend_api
        .token_query_price(&aes_cbc_cryptor, req)
        .await
        .unwrap();
...
async fn test_token_query_by_contract_address() -> Result<(), Error> {
    ...
    let res = backend_api
        .token_query_by_contract_address(&aes_cbc_cryptor, &req)
        .await
        .unwrap();
...
async fn test_token_query_his_price() -> Result<(), Error> {
    ...
    let res = backend_api
        .query_history_price(&aes_cbc_cryptor, &req)
        .await
        .unwrap();
...
async fn test_token_rates() -> Result<(), Error> {
    ...
    let res = backend_api.token_rates(&aes_cbc_cryptor).await.unwrap();
...
async fn test_query_popular_by_page() -> Result<(), Error> {
    ...
    let res = backend_api
        .query_popular_by_page(&aes_cbc_cryptor, &req)
        .await
        .unwrap();
...
async fn _test_token_query_price() -> Result<(), Error> {
    ...
    let res = backend_api
        ._token_query_price(&aes_cbc_cryptor, req)
        .await
        .unwrap();
