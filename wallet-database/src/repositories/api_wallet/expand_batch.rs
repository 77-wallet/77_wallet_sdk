...
impl ExpandBatchRepo {
    ...
    /// 获取所有已完成的批次
    pub async fn get_all_done(pool: &CoreDbPool) -> Result<Vec<ExpandBatchEntity>, crate::Error> {
    ...
    /// 获取所有批次
    pub async fn get_all(pool: &CoreDbPool) -> Result<Vec<ExpandBatchEntity>, crate::Error> {
